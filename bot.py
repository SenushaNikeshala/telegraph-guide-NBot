...
bot = TelegramClient(None, api_id=6, api_hash="eb06d4abfb49dc3eeb1aeb98ae0f581e").start(
    bot_token=config("BOT_TOKEN") ("API_HASH") Your API Hash from my.telegram.org
("API_ID") Your API ID from my.telegram.org
("BOT_TOKENY")our bot token from @BotFather
)
...
async def start_(event):
    await event.reply(
        ...
        buttons=[
            [
                Button.url("Repo🌟", url="https://github.com/Neth1841/telegraph-guide-NBot"),
                Button.url(
                    "Developer⚡️", url="https://t.me/Nethmal100"
                ),
            ],
            [Button.url("Channel🌈", url="https://t.me/NBOT_TEAM)],
        ],
    )
